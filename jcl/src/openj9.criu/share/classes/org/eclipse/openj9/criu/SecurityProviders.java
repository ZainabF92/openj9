...
public class SecurityProviders {
    ...
    public static void registerResetDigests() {
        J9InternalCheckpointHookAPI.registerPreCheckpointHook(CRIUSupport.RESET_DIGESTS_PRIORITY, "Reset the digests", () -> { //$NON-NLS-1$
    ...
    public static void registerRestoreSecurityProviders() {
        J9InternalCheckpointHookAPI.registerPostRestoreHook(CRIUSupport.RESTORE_SECURITY_PROVIDERS_PRIORITY,
